        ...
        <div class="container">
            <div class="row">
                <div class="box-center w-100">
                    <div class="title">
                    <?= $Lang->get('SUPPORT__PROBLEMQUESTION', ['{ID_TICKET}' => $ticket['Ticket']['id']]) ?> <?= $Support->getUser('pseudo', $ticket['Ticket']['author']); ?>
                    </div>
                    <div class="subtitle">
                    <?= $Lang->get('SUPPORT__IN_A_CATEGORIE', ['{NAME}' => $Support->getCategorie($ticket['Ticket']['categorie'])]); ?>
                    </div>
